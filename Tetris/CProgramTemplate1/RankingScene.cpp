...
void ranking_input_name_draw(void)
{
	...
	SetFontSize(37);
	DrawFormatString(791, 530, GetColor(255, 255, 255), "消");
	DrawFormatString(842, 530, GetColor(255, 255, 255), "決");
	DrawFormatString(892, 530, GetColor(255, 255, 255), "終");
